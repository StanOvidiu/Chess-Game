...
namespace Proiect_AI2
{
    class Queen : Piece
    {
        public string whiteQueen = "images/queen-w.png";
        public string blackQueen = "images/queen-b.png";
        public const int whiteValue = 9;
        public const int blackValue = -9;
        public Queen(PieceColor color, int rNumber, int cNumber) : base(color, rNumber, cNumber)
        {
